...
class RegistrationTest(TestCase):
    ...
    def test_add_an_account_in_registration_page_with_valid_email(self):
        ...
        response = self.client.post(reverse('register'), {
                                    'username': 'User1', 'email': 'User1@gmail.com', 'password1': 'isp123456', 'password2': 'isp123456'})
    ...
    def test_can_not_registration_with_invalid_email(self):
        ...
        response = self.client.post(
            reverse('register'), {'username': 'User2', 'email': 'User2 email', 'password1': 'isp123456', 'password2': 'isp123456'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_not_registration_with_password_do_not_match_confirmation_password(self):
        ...
        response = self.client.post(reverse('register'), {
                                    'username': 'User3', 'email': 'User3@gmail.com', 'password1': 'isp123456', 'password2': 'isp234567'})
        self.assertEqual(response.status_code, 200)

    def test_can_not_registration_with_weak_password(self):
        """If password that too weak, account creation failed."""
        response = self.client.post(reverse('register'), {
                                    'username': 'User4', 'email': 'User4@gmail.com', 'password1': '12345678', 'password2': '12345678'})
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_not_registration_with_that_username_already_exists(self):
        ...
        response = self.client.post(reverse('register'), {
                                    'username': 'User1', 'email': 'User6@gmail.com', 'password1': 'isp123456', 'password2': 'isp123456'})
        self.assertEqual(response.status_code, 200)
